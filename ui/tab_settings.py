...
class _GoalTab(QWidget):
    ...
    def _build(self):
        ...
        _hl.setSpacing(6)
        _hl.addWidget(self.p_income)
        _hl.addWidget(QLabel("円"))
        p_form.addRow("月収目標", _w)
        ...
        _hl.setContentsMargins(0,0,0,0)
        _hl.setSpacing(6)
        _hl.addWidget(self.p_expense)
        _hl.addWidget(QLabel("円"))
        p_form.addRow("支出上限", _w)
        ...
        _hl.setContentsMargins(0,0,0,0)
        _hl.setSpacing(6)
        _hl.addWidget(self.c_income)
        _hl.addWidget(QLabel("円"))
        c_form.addRow("月次売上目標", _w)
        ...
        _hl.setContentsMargins(0,0,0,0)
        _hl.setSpacing(6)
        _hl.addWidget(self.c_expense)
        _hl.addWidget(QLabel("円"))
        c_form.addRow("経費上限", _w)
        ...
        _hl.setContentsMargins(0,0,0,0)
        _hl.setSpacing(6)
        _hl.addWidget(self.c_mrr)
        _hl.addWidget(QLabel("円"))
        c_form.addRow("MRR目標", _w)
